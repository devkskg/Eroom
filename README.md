![image](https://github.com/user-attachments/assets/1406a262-b02a-460c-ab52-d6673f4e2ca0)# 📘 Eroom 그룹웨어  
...
- **Eroom 그룹웨어**: https://1242-61-83-250-225.ngrok-free.app
...
| 메뉴 / 영역 | 기능 설명 |
|--------------|------------|
| 📇 **주소록** | 회사 및 협력업체 구분, 개인 메모 기능 포함, 부서/팀 이동, 추가, 삭제 가능 |
| 📑 **결재** | 결재자/합의자/참조자 지정, 결재 상태 관리, 완료 시 알림 발송, PDF 문서 자동 생성 *(로컬만 지원, 배포 적용 개발 중)* |
