...
public class GptService {
    ...
    public String askGpt(String prompt) {
        ...
        String systemPrompt = """
                ...
                [홈]
                그룹웨어에 로그인하면 가장 먼저 보이는 화면으로, 최근 결재 요청, 일정, 공지사항 등의 요약 정보를 한눈에 확인할 수 있습니다.<br>
                알림 기능도 있어 해당하는 기능에 빠르게 접근할 수 있습니다.<br>
                홈 url : https://http//localhost:8080/

                [주소록]
                사내 임직원 및 외부 협력사 정보를 확인할 수 있습니다.<br>
                부서, 직책, 이름 등으로 검색 가능하며, 사내 주소록에서 사원 이름 클릭시 구성원 프로필 카드를 조회할 수 있습니다.<br>
                프로필 카드에는 간략한 프로필과 개인 메모기능을 사용할 수 있습니다.<br>
                조직도 보기 기능이 지원됩니다.<br>
                ...
                [이메일]
                회사 내외부와 메일을 주고받을 수 있으며, 받은메일함, 보낸메일함, 임시보관함, 중요메일함, 휴지통으로 구성된 다양한 폴더로 구분되어 있습니다.<br>
                중요 표시, 첨부파일, 수신확인 등의 기능도 포함되어 있습니다.<br>
                ...
                [채팅]
                사내 구성원 간 실시간 채팅이 가능합니다.<br>
                1:1 채팅뿐 아니라 그룹 채팅방을 만들 수 있으며, 파일 전송 기능이 지원됩니다.<br>
                메시지 알림 기능과 읽음 표시 기능도 포함되어 있습니다.<br>
                ...
                [프로젝트]
                사내 프로젝트를 생성하고, 팀원을 배정해 협업을 관리할 수 있습니다.<br>
                프로젝트 시작일, 종료일, 목표 등을 설정할 수 있으며, 할 일 목록, 진행률, GitHub 연동 등의 기능을 통해 체계적으로 업무를 관리할 수 있습니다.<br>
                ...
                [캘린더]
                개인, 팀, 전사 일정 등록이 가능합니다.<br>
                알림 설정, 회의 초대 기능도 포함되어 있으며, 프로젝트나 결재 일정과도 연동되어 전체 일정을 통합적으로 관리할 수 있습니다.<br>
                ...
                [예약]
                회의실, 차량 등 자원을 예약할 수 있는 기능입니다.<br>
                사용 시간, 장소, 목적을 입력하면 자동으로 중복 예약 여부를 확인하고 예약을 등록합니다.<br>
                관리자 화면에서 예약 현황을 한눈에 확인할 수 있습니다.<br>
                ...
                폴더를 생성하여 문서 및 파일을 체계적으로 정리할 수 있으며, 개인 드라이브와 팀 공유 드라이브가 구분되어 있습니다.<br>
                드라이브 세부 정보를 통해 전체 파일 수, 총 다운로드 수, 파일 유형별 점유 용량 등을 조회할 수 있습니다.<br>
                ...
                [마이페이지]
                개인의 정보(이름, 이메일 연락처 등)를 확인하고, 프로필 사진 변경, 개인정보(이름, 연락처, 주소)변경 등을 할 수 있고 근태 정보 조회가 가능합니다.<br>
                마이페이지 url : http://localhost:8080/mypage/list

                [알림]
                결재 요청, 프로젝트 초대, 캘린더 일정 알림 등 주요 이벤트는 우측 상단 종 아이콘으로 표시됩니다.<br>
                알림은 읽음 여부가 구분 가능하며, 클릭 시 관련 기능으로 바로 이동할 수 있습니다.<br>
                알림 url : http://localhost:8080/notification

                [설문조사]
                사내 설문조사를 생성하고 구성원들의 의견을 수렴할 수 있는 기능입니다.<br>
                복수 선택, 익명 투표, 문항 설정이 가능합니다.<br>
                정해진 마감일 이후에는 최다 투표 결과를 확인 가능합니다.<br>
    ...
    public String summarizeMeetingContent(String meetingContent) {
	    ...
	    - 회의 기록에 없는 내용을 사실인것처럼 요약하지 마세요.
	    - 회의 기록이 짧아서 요약할 내용이 없을 경우는 '내용이 짧아 요약할 수 없습니다.' 라고 답변.
	    - 요약이 불가능한 내용일 경우엔 그냥 '요약 불가능한 내용입니다.' 라고 답변.
